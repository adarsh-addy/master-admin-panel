...
export default function UserCustomerdetails() {
  ...
  async function handleClick(e) {
    ...
    let resp = await axios
      .post("http://localhost:5800/backend/userSave", {
        mobile,
        eng_name,
        cust_name,
        contactor_mobile,
  ...
  async function handleClickId(idx) {
    ...
    let idResult = await axios.post("http://localhost:5800/backend/useridresult", {
      id: idx,
    });
  ...
  async function handleUpdate(e) {
    ...
    e.preventDefault();
    let resp = await axios
      .patch("http://localhost:5800/backend/userUpdate", {
        id,
        mobile,
        eng_name,
        cust_name,
                    ...
                    <Form>
                      ...
                      >
                        ...
                        <Form.Control
                          ...
                          onChange={(e) => {
                            setContactor_mobile(e.target.value);
                      ...
                      >
                        ...
                        <Form.Control
                          ...
                          onChange={(e) => {
                            setContactor_name(e.target.value);
                      ...
                      >
                        ...
                        <Form.Control
                          ...
                          onChange={(e) => {
                            setState_of_work(e.target.value);
                            e.target.value ? setError8(false) : setError8(true);
                          }}
                          value={state_of_work}
                        />
                      </Form.Group>
                      ...
                      >
                        ...
                        <Form.Control
                          ...
                          onChange={(e) => {
                            setNo_of_storey(e.target.value);
                            e.target.value ? setError9(false) : setError9(true);
                          }}
                          value={no_of_storey}
                        />
                      </Form.Group>
                      ...
                      >
                        ...
                        <Form.Control
                          ...
                          onChange={(e) => {
                            setVisit_egg_name(e.target.value);
                            e.target.value
                              ? setError11(false)
                              : setError11(true);
                          }}
                      ...
                      >
                        ...
                        <Form.Control
                          ...
                          onChange={(e) => {
                            setVisit_egg_mobile(e.target.value);
                            e.target.value
                              ? setError12(false)
                              : setError12(true);
                          }}
